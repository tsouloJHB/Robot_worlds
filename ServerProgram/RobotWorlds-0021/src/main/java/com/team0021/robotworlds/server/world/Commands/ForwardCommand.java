...
/**
 * Class provides implementation for the ForwardCommand. It is an extention of the
...
public class ForwardCommand extends Command {
    ...
    /**
     * Class constructor for the ForwardCommand.
     * @param argument
    */
    ...
    /**
     * Method provides implementation of the ForwardCommand instruction.
    ...
    */
    ...
    public boolean execute(CharacterAbstract characterObject) {
        ...
        String victim = ForColor.BoldAndGreen.format("["+ getIdentifier(characterObject.getCharacterIdentifier())+"]");

        switch (worldObject.updatePosition(characterObject, nrSteps)){
            case SUCCESS:{
                characterObject.setMessage("Moved forward by "+nrSteps+" steps.");
            ...
            case FAILED_PITFALL:{
                ...
                ForColor.BoldAndYellow.format("Psst... Guess what? "+victim+" just fell into a pitfall, LOL :D");
