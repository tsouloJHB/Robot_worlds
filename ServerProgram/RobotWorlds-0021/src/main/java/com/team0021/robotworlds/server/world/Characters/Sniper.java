...
public class Sniper extends CharacterAbstract {
    ...
    private Position sniperPosition;
    private String sniperDirection;
    ...
    public Sniper(String teamName){
        ...
        this.sniperDirection = "NORTH";
        this.characterType = CharacterType.SNIPER;
    ...
    public void setCharacterPosition(Position newPosition) {
        this.sniperPosition = newPosition;
    ...
    */
    ...
    public String toString() {
       return "[" + this.sniperPosition.getX() + "," + this.sniperPosition.getY() + "] "
    ...
    public void showHelp() {
        String myRole = ForColor.BoldAndYellow.format("\'SNIPER\'");
