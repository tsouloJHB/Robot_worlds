...
public class Defender extends CharacterAbstract {
    private Positions worldObject;
    private Position defenderPosition;
    private String defenderDirection;
    ...
    public Defender(String teamName){
        super(teamName);
        this.worldObject = ServerHandler.getWorldObject();
        this.teamName = teamName;
        this.defenderDirection = "NORTH";
        this.characterType = CharacterType.DEFENDER;
        this.characterIdentifier = "defender."+teamName;
    ...
    public void setCharacterPosition(Position newPosition) {
        this.defenderPosition = newPosition;
    ...
    */
    ...
    public String toString() {
       return "[" + this.defenderPosition.getX() + "," + this.defenderPosition.getY() + "] "
    ...
    public void showHelp() {
        String myRole = ForColor.BoldAndYellow.format("\'DEFENDER\'");
        ...
        ForColor.BoldAndYellow.format("    mine:\t\t")+ForColor.BoldAndWhite.format("- plant your mines strategically and wait for the fireworks to begin.\n")+
